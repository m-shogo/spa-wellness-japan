    ...
    <ul class="gn_links-01 module_menu-01">
          ...
          <?php if ($header != 'none'): ?>
            <?php if ($select01): ?>
              <li class="_hasChild <?php if ($header == "only-SP"): ?>_only-SP<?php elseif ($header == "over-TB"): ?>_over-TB<?php endif; ?>">
                ...
                <a class="gnl_title mm_title" href="<?php echo $url01; ?>" <?php if ($target01): ?>target="_blank" <?php endif; ?>><span><?php echo $title01; ?></span><span class="en"><?php echo $en01; ?></span></a>
                <div class="gnl_wrapper mm_wrapper-01">
                  <div class="gnl_inner mm_inner-01">
                    <div class="gnl_title">
                      <a href="<?php echo $url01; ?>" <?php if ($target01): ?>target="_blank" <?php endif; ?>>
      ...
      <?php if (have_rows('common-submenu-01', 'option')): ?>
        <?php while (have_rows('common-submenu-01', 'option')): the_row(); ?>
          ...
          ?>
          <?php if ($header != 'none'): ?>
            <li class="_sub <?php if ($header == "only-SP"): ?>_only-SP<?php elseif ($header == "over-TB"): ?>_over-TB<?php endif; ?>">
              <a class="gnl_title mm_title" href="<?php echo $url; ?>" <?php if ($target): ?>target="_blank" <?php endif; ?>><span><?php echo $title; ?></span></a>
            </li>
          <?php endif; ?>
        <?php endwhile; ?>
      <?php endif; ?>
